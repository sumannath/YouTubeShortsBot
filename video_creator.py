...
class VideoCreator:
    ...
    def create_short_video(self, story):
        ...
        try:
            ...
            return self._create_video_with_assets(story, background_path, audio_path, output_filename)

        except Exception as e:
            logging.error(f"Error creating short video: {e}")
            return None

    def _create_video_with_assets(self, story, background_video_path, audio_path, output_filename):
